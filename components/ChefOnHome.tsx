        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-[20px] mt-[50px]">
            <Image
              src="/chef1.png"
              alt="Chef 1"
              className="w-[180px] md:w-[280px] md:h-[260px] cursor-pointer"
              width={312}
              height={391}
            />
            <Image
          ...
          <div className="flex justify-center mt-[30px]">
            <button className="px-8 py-2 border border-[#e58b0a] rounded-lg text-white text-sm md:text-lg font-medium transition-all shadow-lg">
              See More
            </button>
          </div>
        </section>
